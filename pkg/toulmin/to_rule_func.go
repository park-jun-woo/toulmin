...
// Supports func(any,any,any)(bool,any) and legacy func(any,any)(bool,any).
// Panics if fn is neither.
func toRuleFunc(fn any) func(any, any, any) (bool, any) {
	switch f := fn.(type) {
	...
	case func(any, any) (bool, any):
		return wrapLegacy(f)
	default:
		panic("toulmin: fn must be func(any,any,any)(bool,any) or func(any,any)(bool,any)")
	}
}
